...
/* v2.2.4：缓存名从 star-ember-v221-report-hardening 升级为 star-ember-v225-release。
...
assert.ok(sw.includes('star-ember-v225-release'),'service worker cache key must be v2.2.4 cache-safe');
