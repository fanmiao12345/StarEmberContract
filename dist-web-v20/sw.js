...
const CORE=['./','./index.html','./styles.ae3e4d1aef.css','./game-data.037c0e247e.js','./app.e66183e0be.js','./asset-loader.78c53591d4.js','./asset-manifest.v20.json','./version.json','./manifest.webmanifest','./cloud-config.8869d4112d.js','./cloud-bridge.5424307ad7.js','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
